...
// import MicroTokenBuild from '../build/contracts/MicroToken.json';
...
export const SmartContractContextProvider = ({ children }) => {
	...
	const context = { web3, CarRentalContract, MicroTokenContract, UserIdentityContract, BankLoanContract };
	return (
